...
if (Util.hasClass = function (t, e) {
    ...
    function () {
        ...
        t.prototype.getPreventScrollEl = function () {
            ...
            return e && (t = document.querySelector(e)),
                t
        },
                ...
                Util.addClass(this.element, this.showClass),
                    ...
                    this.moveFocusEl && (this.moveFocusEl.focus(),
                        this.element.addEventListener("transitionend", function t(e) {
                            s.moveFocusEl.focus(),
                                s.element.removeEventListener("transitionend", t)
                        })),
            ...
            t.prototype.initKeyDown = function (t) {
                t.keyCode && 9 == t.keyCode || t.key && "Tab" == t.key ? this.trapFocus(t) : (t.keyCode && 13 == t.keyCode || t.key && "Enter" == t.key) && t.target.closest(".js-modal__close") && (t.preventDefault(),
                    this.closeModal())
            }
            ,
            t.prototype.initClick = function (t) {
                (t.target.closest(".js-modal__close") || Util.hasClass(t.target, "js-modal")) && (t.preventDefault(),
                    this.closeModal())
            }
            ,
            t.prototype.trapFocus = function (t) {
                this.firstFocusable == document.activeElement && t.shiftKey && (t.preventDefault(),
                    this.lastFocusable.focus()),
                    this.lastFocusable != document.activeElement || t.shiftKey || (t.preventDefault(),
                        this.firstFocusable.focus())
            }
            ,
            t.prototype.getFocusableElements = function () {
                var t = this.element.querySelectorAll(l);
                this.getFirstVisible(t),
                    this.getLastVisible(t),
            ...
            window.Modal = t;
        var e, i = document.getElementsByClassName("js-modal"), l = '[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex]:not([tabindex="-1"]), [contenteditable], audio[controls], video[controls], summary';
        if (0 < i.length) {
...
Util.addClass = function (t, e) {
    ...
    Util.extend = function () {
        ...
        for (var l = function (t) {
            for (var e in t)
                Object.prototype.hasOwnProperty.call(t, e) && (i && "[object Object]" === Object.prototype.toString.call(t[e]) ? s[e] = extend(!0, s[e], t[e]) : s[e] = t[e])
        }; t < e; t++) {
            l(arguments[t])
        }
        return s
    ...
    function () {
        var i = function (t) {
            ...
            this.options = Util.extend(i.defaults, t),
                ...
                function (t) {
                    var e = "";
                    0 != t.startTime[1] && (e += t.halfHourGrid,
                        t.startTime[0] = t.startTime[0] + 1,
                        t.gridRows = t.gridRows + 1);
                    for (var s = t.endTime[0] - t.startTime[0], i = 0; i < s; i++)
                        e = e + n(t, i) + t.halfHourGrid;
                    e += n(t, s),
                        t.gridRows = t.gridRows + 2 * s,
                        0 != t.endTime[1] && (e += t.halfHourGrid,
                            t.gridRows = t.gridRows + 1),
                        t.grid[0].innerHTML = e,
                        t.element.style.setProperty("--w-schedule-row-nr", t.gridRows)
                }(e = this),
                function (t) {
                    for (var e = t.element.getElementsByClassName("js-w-schedule__event"), s = 0; s < e.length; s++)
                        l(t, e[s])
                }(e),
                (s = e).modal.length < 1 || s.morphBg.length < 1 || (s.modalContent = s.modal[0].getElementsByClassName("js-w-schedule-modal__content")[0],
                        ...
                        s.target = t.detail.closest('[aria-controls="' + s.modalId + '"]'),
                            function (a, o) {
                                ...
                                var g = function (t) {
                                    ...
                                    a.morphBg[0].style.transform = "translateX(" + l + "px) translateY(" + n + "px) scaleX(" + s + ") scaleY(" + i + ")",
                                        e < m ? window.requestAnimationFrame(g) : o && o()
                                };
                                window.requestAnimationFrame(g)
                            }(s, function () {
                                Util.addClass(s.morphBg[0], "hide"),
                                    s.morphBg[0].style = "",
                                    Util.removeClass(s.modalContent, "opacity-0")
                            }),
                            (e = s).options.searchData(e.target, function (t) {
                                Util.addClass(e.modalContent, "w-schedule-modal__content--loaded"),
                                    e.modalContent.innerHTML = t
                                // 🔁 Exécuter les <script> présents dans le HTML injecté
                                const scripts = e.modalContent.querySelectorAll('script');
                    ...
                    s.modal[0].addEventListener("modalIsClose", function (t) {
                        s.modal[0].addEventListener("transitionend", function t(e) {
                            "opacity" == e.propertyName && (c(s),
                                s.modal[0].removeEventListener("transitionend", t))
                        }),
                            s.target = !1,
                            o(s, !1),
                            f && c(s)
                    }),
                    0 < s.modalCloseBtn.length && s.modalCloseBtn[0].addEventListener("click", function (t) {
                        s.modal[0].click()
                    }))
        };
        i.prototype.update = function () {
            ...
            (function (t) {
                ...
                var s = t.endTime[0] - t.startTime[0];
                for (var i = 0; i < s; i++) {
                    e += n(t, i) + t.halfHourGrid;
                }
                e += n(t, s);
                t.gridRows += 2 * s;
                if (0 != t.endTime[1]) {
            ...
            var events = this.element.getElementsByClassName("js-w-schedule__event");
            for (var i = 0; i < events.length; i++) {
                l(this, events[i]);
            }

            // Réinitialiser le contenu de la modale si visible
            ...
            // 🔁 Réattacher les listeners de click pour tous les déclencheurs dynamiques
            if (this.modal.length > 0) {
                var modalId = this.modal[0].getAttribute("id");
                var triggers = document.querySelectorAll('[aria-controls="' + modalId + '"]');
        ...
        function c(t) {
            Util.addClass(t.modalContent, "opacity-0"),
                t.modalContent.innerHTML = t.skeletonContent,
                Util.removeClass(t.modalContent, "w-schedule-modal__content--loaded")
        }
        (window.WSchedule = i).defaults = {
            element: "",
            searchData: !1
        };
